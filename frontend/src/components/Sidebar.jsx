  ...
  const loanSections = [
    {
      ...
      links: [
        ...
        { to: "/dashboard/create-loan-booking", label: "Create Loan Booking" },
        { to: "/dashboard/ev-loans/upload-utr", label: "Upload UTR" },
        { to: "/dashboard/manual-rps-upload", label: "Manual RPS Upload" },
        { to: "/dashboard/repayments-upload", label: "Repayments Upload" },
        { to: "/dashboard/create-loan-charges", label: "Create Charges Upload" },
        { to: "/dashboard/delete-cashflow", label: "Delete Cashflow Upload" },
        { to: "/dashboard/forecloserUpload", label: "Foreclosure & Charges Upload" },
      ],  
    },
    {
      key: "evLoans",
